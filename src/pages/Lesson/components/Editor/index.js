...
export { ReadOnly, Editable, Highlightable, Template, StartCode } from './components/CodeBlock/components/index.js';

// Export all DescriptionBlock child components  
export { CodeSnippet, Highlight, Tip, Section, Task, Quiz } from './components/DescriptionBlock/components/index.js';
